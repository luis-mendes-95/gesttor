...
$sql = "INSERT INTO tb_portfolio (descricao,valor,
tipo,item1,qtd1,custo1,item2,qtd2,custo2,item3,qtd3,custo3,item4,qtd4,custo4,item5,qtd5,custo5,item6,qtd6,custo6,
item7,qtd7,custo7,item8,qtd8,custo8,item9,qtd9,custo9,item10,qtd10,custo10,custototal,margem) 
values 
('$descricao','$valor','$tipo','$item1','$qtd1','$custo1','$item2','$qtd2','$custo2','$item3','$qtd3','$custo3',
'$item4','$qtd4','$custo4','$item5','$qtd5','$custo5','$item6','$qtd6','$custo6',
'$item7','$qtd7','$custo7','$item8','$qtd8','$custo8','$item9','$qtd9','$custo9','$item10','$qtd10','$custo10',
'$custototal','$margem')";
